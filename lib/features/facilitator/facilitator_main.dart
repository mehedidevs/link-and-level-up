...
import '../tariner/trainer_request.dart';
import 'facilitator_profile_page.dart';
import 'facilitator_session.dart';
import 'home_screen.dart';

class FacilitatorMain extends StatefulWidget {
  const FacilitatorMain({super.key});

  @override
  State<FacilitatorMain> createState() => _AthleteMainPageState();
}

class _AthleteMainPageState extends State<FacilitatorMain> {
  var currentIndex = 0;
        ...
        child: ListView(
          children: <Widget>[
            ...
            DrawerItem(
              ...
              text: 'Profile',
              onTap: () {
                Navigator.pushNamed(context, AppRoutes.FacilityProfileDetails);
              },
            ),
            DrawerItem(
