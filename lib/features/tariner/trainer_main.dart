...
import 'package:link_level_up/features/tariner/trainer_community_screen.dart';
import 'package:link_level_up/features/tariner/trainer_home.dart';
import 'package:link_level_up/features/tariner/trainer_profile.dart';
import 'package:link_level_up/features/tariner/trainer_request.dart';
import 'package:link_level_up/features/tariner/trainer_session.dart';
...
class TrainerMain extends StatefulWidget {
  const TrainerMain({super.key});

  @override
  State<TrainerMain> createState() => _AthleteMainPageState();
}

class _AthleteMainPageState extends State<TrainerMain> {
  var currentIndex = 0;
  List<BottomBarData> listOfIcons = [
    BottomBarData(iconData: 'icons/ic_home.svg', title: 'Home'),
    BottomBarData(iconData: 'icons/ic_menu_session.svg', title: 'Session'),
    BottomBarData(iconData: 'icons/ic_menu_community.svg', title: 'Community'),
    BottomBarData(iconData: 'icons/ic_menu_request.svg', title: 'Request'),
        ...
        child: ListView(
          children: <Widget>[
            ...
            DrawerItem(
              ...
              text: 'Profile',
              onTap: () {
                Navigator.pushNamed(context, AppRoutes.TrainerProfilePage);
              },
            ),
            DrawerItem(
...
class MessageIconWithBadge extends StatelessWidget {
  ...
  // Constructor to accept dynamic badge count
    ...
    return Stack(
      ...
      children: [
        SizedBox(
            height: 24,
            width: 24,
            child: SvgPicture.asset('icons/ic_message_badge.svg')),
        Positioned(
          right: 3.5,
          child: Text(
            badgeCount.toString(),
