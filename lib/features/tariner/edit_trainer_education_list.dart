...
class EditTrainerEducationList extends StatefulWidget {
  const EditTrainerEducationList({super.key});

  @override
  State<EditTrainerEducationList> createState() => _EditTrainerProfileState();
}

class _EditTrainerProfileState extends State<EditTrainerEducationList> {
  @override
        ...
        body: ListView(
          ...
          children: [
            InfoSection(
              ...
              onEdit: () {
                Navigator.pushNamed(context, AppRoutes.EditTrainerEducation);
