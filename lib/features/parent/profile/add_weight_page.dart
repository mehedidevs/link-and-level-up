...
class _WeightSelectionPageState extends State<WeightSelectionPage> {
  ...
  void initState() {
    super.initState();
    _controller = FixedExtentScrollController(initialItem: 20); // Adjust for starting weight
  }
            ...
            children: [
              Column(
                children: [
                  ...
                  Center(  // Center the entire Column vertically and horizontally
                    child: Column(
                      ...
                      children: [
                        ...
                        WheelSlider(
                          ...
                          onValueChanged: onSelectedWeight,  // This will now accept dynamic
